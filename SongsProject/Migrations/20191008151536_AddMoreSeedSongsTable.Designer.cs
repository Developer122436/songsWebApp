...
namespace SongsProject.Migrations
{
    ...
    [Migration("20191008151536_AddMoreSeedSongsTable")]
    partial class AddMoreSeedSongsTable
    {
            ...
            modelBuilder.Entity("SongsProject.Models.Song", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, Artist = "Jennifer Lopez", Country = "USA", Description = "#1 USA", MusicStyle = "Pop", Name = "On the floor", Price = 21m, Rating = 0 },
                        new { Id = 3, Artist = "Ariana Grande", Country = "USA", Description = "#1 USA", MusicStyle = "Pop", Name = "7 Rings", Price = 22m, Rating = 0 },
                        new { Id = 4, Artist = "Kobi Marimi", Country = "Israel", Description = "#23 Eurovision", MusicStyle = "Pop", Name = "Home", Price = 11m, Rating = 0 }
                    );
                });
